			...
			"checkcaller()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Returns whether the calling thread was created by this Exploit.",
					].join("\n")
				},
			},
			...
			"getcustomasset()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Generates a rbxasset:// [`content`](https://developer.roblox.com/en-us/articles/Content) URL for the given asset from this Executor's `workspace` directory.",
					].join("\n")
				},
			},
